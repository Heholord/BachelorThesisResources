...
consolefile = io.open("console_log.txt", "w")
...
while true do
	...
	if timeout + timeoutBonus <= 0 or isDead() then
		...
		consoleoutput = "Gen: " .. pool.generation .. "  Species: " .. pool.currentSpecies .. "  Genome: " .. pool.currentGenome	.. "  Fitness: " .. fitness
		
		consolefile:write(consoleoutput .. "\n")
		consolefile:flush()

		emu.print(consoleoutput)
		pool.currentSpecies = 1
		pool.currentGenome = 1
		while fitnessAlreadyMeasured() do
			nextGenome()
