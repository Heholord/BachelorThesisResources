...
def print_all(popCount):
    ...
    for i in range(1, 4):
        ...
        distanceList.append(print_distance_stats(i, generations))
    ...
    print("Avg distance of pop" + str(popCount) + "=" + str(sum(distanceList) / len(distanceList)) + " standard deviation " + str(stdev(distanceList)))
